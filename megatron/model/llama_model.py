...
from megatron.core.utils import scaled_init_method_normal
...
class LLaMAModel(MegatronModule):
    ...
    def __init__(self,
                 ...
                 post_process=True):
        args = get_args()
        super(LLaMAModel, self).__init__(config=config, share_embeddings_and_output_weights=not args.untie_embeddings_and_output_weights)
